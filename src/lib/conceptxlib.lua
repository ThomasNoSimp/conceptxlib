...
local studentData = {
    ...
    { id = 8, name = "Hsu Dagu Naing", age = 14, class = "Secondary 2A", method = "online", email = "hsudagunaing.conceptx@gmail.com"},
    { id = 9, name = "Hsu Htoo Phyu Sin", age = 14, class = "Secondary 2A", method = "online", email = "hsuhtoophyusin.conceptx@gmail.com"},
    { id = 10, name = "Htin Htin Lu Win", age = 14, class = "Secondary 2A", method = "online", email = "HtinHtinluwin.conceptx@gmail.com"},
    ...
    { id = 26, name = "Shoon Lae Lae Kyaw", age = 14, class = "Secondary 2A", method = "online", "shoonlaelaekyaw.conceptx@gmail.com"},
    ...
    { id = 29, name = "Shwe Yee Htet", age = 14, class = "Secondary 2A", method = "online", email = "shweyeehtet.conceptx7@gmail.com"},
    ...
    { id = 34, name = "Thura Wai Zin", age = 14, class = "Secondary 2A", method = "online", email = "thurawaizin.conceptx@gmail.com"},
    { id = 35, name = "Zay Nyi Han", age = 14, class = "Secondary 2A", method = "online", email = "zanynyihanconceptx@gmail.com"},
    { id = 36, name = "Saung Hnin Shan", age = 14, class = "Secondary 2A", method = "online", email = "Unknown"},
}
